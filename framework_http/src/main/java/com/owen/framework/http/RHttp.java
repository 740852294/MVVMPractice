...
import com.owen.framework.http.api.APIService;
import com.owen.framework.http.disposable.DisposableManager;
import com.owen.framework.http.observe.HttpObservable;
import com.owen.framework.http.observe.HttpObserver;
import com.owen.framework.http.result.HttpResult;
import com.owen.framework.http.result.UploadResult;
import com.owen.framework.http.upload.UploadRequestBody;
import com.owen.framework.http.utils.RequestUtils;
import com.owen.framework.http.utils.RetrofitUtils;
...
public class RHttp {
    ...
    /*执行普通Http请求*/
    public <T> void execute(com.owen.framework.http.HttpCallback<T> httpCallback) {
    ...
    /*执行普通Http请求*/
    public <T> void execute(com.owen.framework.http.UploadCallback<T> uploadCallback) {
    ...
    public static final class Builder {
        ...
        /*LifecycleProvider*/
        public Builder lifecycle(LifecycleOwner lifecycleOwner) {
